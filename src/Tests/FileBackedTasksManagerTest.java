...
public class FileBackedTasksManagerTest extends TaskManagerTest <FileBackedTasksManager> {
   ...
   @AfterEach
    ...
    @Test
    void test2_1ShouldUploadAFileForRecording() { //  Загрузка пустого файла
        long uploadedFileSize = file.length();
        assertEquals(0, uploadedFileSize);
    }

    @Test
    void test2_2ShouldWriteTasksToaFile() { //  Загрузка пустого файла
   ...
   @Test
    void test2_3ShouldReadTheTaskFile() { //  Чтение из файла
